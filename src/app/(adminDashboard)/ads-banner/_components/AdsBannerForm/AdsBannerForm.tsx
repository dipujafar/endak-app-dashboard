      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium text-foreground">Upload Banner Image</FormLabel>
                <FormControl>
                  <div
                    className={cn(
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center space-y-3">
                      ...
                      {!selectedFile && (
                        <div className="text-xs text-muted-foreground">Drag and drop or click to select</div>
                      )}
                    </div>
                  </div>
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium text-foreground">Website Link</FormLabel>
                <FormControl>
                  <Input placeholder="Enter website link" {...field} className="w-full" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <div className="space-y-4 bg-form-section rounded-lg">
            <h3 className="text-lg font-medium text-foreground">
              Set Time Frame <span className="text-muted-foreground text-sm">(Optional)</span>
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    <FormLabel className="text-sm font-medium text-foreground">Start Date & Time</FormLabel>
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl>
                          ...
                          >
                            {field.value ? format(field.value, "PPP p") : <span>Enter start date & time</span>}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    <FormLabel className="text-sm font-medium text-foreground">End Date & Time</FormLabel>
                    <Popover>
                      <PopoverTrigger asChild>
                        <FormControl>
                          <Button
                            ...
                            className={cn("w-full pl-3 text-left font-normal", !field.value && "text-muted-foreground")}
                          >
                            {field.value ? format(field.value, "PPP p") : <span>Enter end date & time</span>}
                            <CalendarIcon className="ml-auto h-4 w-4 opacity-50" />
                          </Button>
                        </FormControl>
                      </PopoverTrigger>
