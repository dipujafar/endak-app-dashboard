...
import { FormData, formSchema } from "./schema.utils"
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium text-gray-900">Upload Background Image</FormLabel>
                <FormControl>
                  <div
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium text-gray-900">Title</FormLabel>
                <FormControl>
